...
def main() -> int:
    ...
    parser.add_argument('--server-addr', type=str, help='The server address',
                        default='127.0.0.1', required=False)
    parser.add_argument('--duration', type=int,
                        help='Test duration', default=5)
    parser.add_argument('--trex-config', type=str,
    ...
    trex_config_file_on_server = TREX_FILES_DIR + \
        os.path.basename(args.trex_config)
    ...
    try:
        ...
        if args.force_restart:
            logging.info(
                'Killing all Trexes... with meteorite... Boom!')
